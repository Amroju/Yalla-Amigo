...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "nav.reviews": "Reviews",
    "nav.order": "Order Now",
    "hero.tagline": "World Famous",
    "hero.title": "Shawarma & Falafel",
    "hero.subtitle": "Authentic Middle Eastern flavors crafted with passion and tradition",
    "hero.cta": "Explore Menu",
    "hero.order": "Order on Deliveroo",
    "menu.title": "Our Menu",
    "menu.subtitle": "Discover our selection of authentic Middle Eastern dishes, prepared fresh daily with premium ingredients",
    ...
    "footer.tagline": "Authentic Middle Eastern cuisine since 2018",
    "footer.quickLinks": "Quick Links",
    "footer.contact": "Contact",
    "footer.hours": "Hours",
    "footer.followUs": "Follow Us",
    "footer.rights": "All rights reserved",
    "order.button": "Order on Deliveroo",
  ...
  it: {
    ...
    "hero.order": "Ordina su Deliveroo",
    "menu.title": "Il Nostro Menu",
    "menu.subtitle": "Scopri la nostra selezione di piatti mediorientali autentici, preparati freschi ogni giorno con ingredienti di prima qualità",
    "menu.category.wraps": "Wraps Signature",
    "menu.category.plates": "Piatti Principali",
    "menu.category.appetizers": "Antipasti",
    ...
    "footer.tagline": "Cucina mediorientale autentica dal 2018",
    "footer.quickLinks": "Link Rapidi",
    "footer.contact": "Contatti",
    "footer.hours": "Orari",
    "footer.followUs": "Seguici",
    "footer.rights": "Tutti i diritti riservati",
    "order.button": "Ordina su Deliveroo",

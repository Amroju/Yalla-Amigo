...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "hero.title": "Taste the Middle East",
    "hero.subtitle": "Authentic shawarma & falafel, crafted fresh daily with love in the heart of Verona",
    "hero.cta": "Explore Menu",
    "hero.order": "Order on Glovo",
    "hero.rating": "4.8 on Google",
  ...
  it: {
    ...
    "hero.title": "Assapora il Medio Oriente",
    "hero.subtitle": "Shawarma e falafel autentici, preparati freschi ogni giorno con amore nel cuore di Verona",
    "hero.cta": "Scopri il Menu",
    "hero.order": "Ordina su Glovo",
    "hero.rating": "4.8 su Google",
    "hero.address": "Piazza Cittadella 14",
